<html>
    ...
    <body background="https://news.uthscsa.edu/wp-content/uploads/2020/03/iStock-1141061856.jpg" >
        ...
        <div class="container" >
            <h1 style="margin-top:40px;color: white;" class=" text-center display-4 font-weight-bold ">Call Back Form</h1>
            <div class="table-responsive">
                <table style="margin-top:30px;" class="table table-bordered ">
                    ...
                    <?php 
                      ...
                      $selectquery = "SELECT * FROM callbackform ";
